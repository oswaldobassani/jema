// Decompiled by DJ v3.9.9.91 Copyright 2005 Atanas Neshkov  Date: 4/11/2006 13:58:03
...
public final class BasicJMD extends Panel implements JMD, WindowListener
{
    ...
    class ModButton extends Button
    {
        ...
        public ModButton(String name, BasicModule m, PlugIn p)
        {
            ...
            addMouseListener(new MouseAdapter() {
                ...
                {
                    updateStatus();
                    System.out.println("mouseEntered: "+plugin);
                    mouseHere = true;
                }

                public void mouseExited(MouseEvent me)
                {
                	System.out.println("mouseExited: "+plugin);
                    mouseHere = false;
                }

				public void mousePressed(MouseEvent arg0) {
					System.out.println("mousePressed: "+plugin);
					if(plugin instanceof IConfiguracao){
						IConfiguracao conf = (IConfiguracao)plugin;
						if(getParent() instanceof JFrame){
							conf.openDialogConfiguracao((JFrame)getParent());
						}else{
							conf.openDialogConfiguracao(null);
						}
					}
				}
    ...
    public BasicJMD(String title)
    {
    	...
    	System.out.println("BasicJMD: "+title);
